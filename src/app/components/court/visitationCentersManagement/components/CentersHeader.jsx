...
export function CentersHeader({ onBack }) {
  return (
    <div className="relative w-full bg-[#1e3a8a] rounded-[2rem] p-5 md:p-6 text-white flex items-center justify-between overflow-hidden shadow-xl">
      ...
      <div className="flex items-center gap-4 md:gap-5 relative z-10">
        ...
        <div>
          <h1 className="text-xl md:text-2xl font-bold mb-1">مراكز الرؤية المعتمدة</h1>
          <p className="text-blue-200 text-xs md:text-sm opacity-90 font-bold tracking-wide">إدارة سجل أماكن الزيارة وموظفي الاستقبال</p>
        </div>
      </div>
