...
export function LoginForm({
  ...
  userFieldName, pwdFieldName, handleInputChange, handleKeyPress, handleLogin
}) {
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 animate-in fade-in duration-500">
      ...
      <div className="space-y-6">
        ...
        <div style={{ position: 'absolute', opacity: 0, zIndex: -1, width: '1px', height: '1px', overflow: 'hidden' }} aria-hidden="true">
          <input type="text" name="chrome_trap_court_user" autoComplete="username" tabIndex={-1} />
          <input type="password" name="chrome_trap_court_pass" autoComplete="current-password" tabIndex={-1} />
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 text-[#95a5a6] hover:text-[#2c3e50] transition-colors focus:outline-none"
              disabled={isLoading}
            >
