    ...
    <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 animate-in zoom-in-95 duration-300 relative overflow-hidden border-t-4" style={{ borderColor: '#2c5aa0' }}>
      ...
      <div className="space-y-6">
        ...
        <div style={{ position: 'absolute', opacity: 0, zIndex: -1, width: '1px', height: '1px', overflow: 'hidden' }} aria-hidden="true">
          <input type="password" name="fake_court_pwd" autoComplete="current-password" tabIndex="-1" />
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            />
            <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#95a5a6] hover:text-[#2c3e50] focus:outline-none">
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              onKeyDown={handleKeyPress}
            />
            <button type="button" onClick={() => setShowNewPassword(!showNewPassword)} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#95a5a6] hover:text-[#2c3e50] focus:outline-none">
